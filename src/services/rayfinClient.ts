...
import type { ChatAppSchema } from '../../rayfin/data/schema';
...
type AppRayfinClient = RayfinClient<ChatAppSchema, AppFunctionsSchema>;
...
export async function initRayfinClient(
  ...
  client = new RayfinClient<ChatAppSchema, AppFunctionsSchema>({
